...
export const Notification = () => {
    ...
    const icon = type === NotificationType.success ? success : type === NotificationType.failure ? failure : loading;
    const message = type === NotificationType.success ? successMessage : type === NotificationType.failure ? failureMessage : loadingMessage;
            ...
            <div className='w-full flex flex-col items-center space-y-4 sm:items-end'>
                ...
                <div className='p-4'>
                    ...
                    <div className='ml-4 flex-shrink-0 flex'>
                        <button type='button' className='bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-phantom' onClick={() => notification.setNotification(NotificationType.none)}>
